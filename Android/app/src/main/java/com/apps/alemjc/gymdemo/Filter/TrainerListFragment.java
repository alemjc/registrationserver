...
public class TrainerListFragment extends Fragment {
    ...
    private void getPhotos(){
        ...
        photo1.setCaption("Robin Zhang");
        photo1.setTags("not sure");
        photo1.setReviews("5");
        photo1.setCost("$40.00");
        photo1.setTags("not sure");
        ...
        photo2.setCaption("Josiah Kam");
        photo2.setReviews("3.7");
        photo2.setCost("$15.00");
        ...
        photo3.setCaption("Jean Carlos");
        photo3.setReviews("4.6");
        photo3.setCost("$20.00");
